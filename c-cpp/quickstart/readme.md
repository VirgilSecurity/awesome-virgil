...
This is quickstart guide that helps to start using C++ implementation of:
  ...
  * [Virgil Private Keys Service](https://virgilsecurity.com/developers/c-cpp/keys-private-service) and it's [SDK](https://github.com/VirgilSecurity/virgil-sdk-cpp/tree/release/virgil.sdk.private-keys).
