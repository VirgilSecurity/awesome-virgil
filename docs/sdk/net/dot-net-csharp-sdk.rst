...
.. toctree::
   ...
   Tutorial <dot-net-csharp-programming-guide>
   Guides <guides>


Welcome to the .NET SDK Programming Guide for C#.

In this guide you will find code for every task you'll need to implement to create an application for the Windows/Xamarin platform using Virgil Security. It also includes a description of the main classes and methods. The code examples in this guide are written in C#.
