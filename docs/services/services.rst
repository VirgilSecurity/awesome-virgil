...
-  `Cards service <cards/v4/cards-service>`__
-  `Identity Service <identity/v1/identity-service>`__

.. toctree::
   :maxdepth: 1
   
   Cards service <cards/v4/cards-service>
   Identity Service <identity/v1/identity-service>