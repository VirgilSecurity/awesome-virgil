...
3. Check that all dependencies from the table above in `Step 1 - Choose target language and platform`__ are accessible.
4. Set environment variables according to the table above in `Step 1 - Choose target language and platform`__.
